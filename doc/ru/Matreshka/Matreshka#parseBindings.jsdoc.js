...
@desc Начиная с версии 1.1, Matreshka.js включает в себя простой DOM парсер, обрабатывающий синтаксические конструкции, заключенные в двойные фигурные скобки. Метод ``parseBindings`` первым аргументом принимает HTML строку, DOM узел или селектор, соответствующий DOM узлу.
...
#### Не противоречит ли это идеологии фреймворка ("вся логика должна быть заключена в JavaScript файле")?
