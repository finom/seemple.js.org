...
@example <caption>Если передать флаг ``replaceData``, установленный как ``true`` в объект события, то свойства, которые не входят в переданный объект, будут удалены из списка свойств, отвечающих за данные</caption>
this
	.addDataKeys(['a', 'b', 'c'])
	.setData({
		a: 1,
