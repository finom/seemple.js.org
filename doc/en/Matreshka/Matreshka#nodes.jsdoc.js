...
@desc Pay attention, every object property has got the first node of the bound ones to the corresponding property. Use {@link Seemple#$nodes} for getting all the nodes bound to a certain property.
@see {@link Seemple#bindNode}
@example
this.bindNode('myKey', '.my-node');
