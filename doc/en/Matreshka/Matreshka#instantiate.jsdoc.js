...
The method creates and fixes an instance of a class as given property value. When you try to override the property, instead of actual overriding, the instance is updated. Thus, we achieve integrity of an application, made on with Matreshka.js.
...
> It looks easy in practice: you create an ordinary class which almost always receives some data to be handled (for example, to use it at {@link Matreshka.Object#setData} method).
...
- If ``updateCallback`` function isn't given and the class isn’t inherited from {@link Matreshka.Object} or {@link Matreshka.Array}, the instance is extended by object properties which is trying to to be assigned.

> A feature of this method is an absence of limitations on the class source. Any function-constructor that can be initialized using ``new`` operator and not only {@link Matreshka}'s successors can act as a class.
