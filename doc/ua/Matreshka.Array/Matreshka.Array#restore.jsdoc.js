...
@fires add
@fires addone
@summary Відтворює {@link Seemple.Array} з HTML вузлів на сторінці.
...
При відтворенні, на кожному елементі масиву генерується подія ``render`` і викликаються методи ``onRender`` і ``onItemRender`` (див {@link Seemple.Array#onItemRender документацію}), як і при {@link Seemple.Array#itemRenderer звичайному рендерингу}.
