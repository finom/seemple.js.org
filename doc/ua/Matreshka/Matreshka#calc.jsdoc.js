...
> Зверніть увагу, що у метода є {@link Seemple.calc статичний аналог}, який працює в точності так само, але приймає будь-який об'єкт в якості першого аргументу, зсуваючи інші аргументи вправо.
```js
...
У разі, якщо потрібно змінити значення властивості-джерела і зробити це так, щоб цільова властивість не була обчислена заново, використовуйте метод {@link Seemple#set} з прапором ``skipCalc`` рівним ``true``.
...
@variation batch
@since 2.0
@summary Додаткова можливість методу {@link Seemple#calc}, що дозволяє оголосити кілька обчислюваних властивостей одним викликом
...
``source`` може приймати будь-який вид {@link Seemple#calc опис вище} (рядок, масив рядків, об'єкт з властивостями ``key`` і ``object``, масив таких об'єктів).
