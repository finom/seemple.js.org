...
@importance 2
@variation 2
@summary Альтернативний синтаксис ``unbindNode``, що дозволяє передати об'єкт з байндінгамі. Див. {@link Seemple#bindNode(2)}
...
Ця варіація методу зручна тим, що її синтаксис збігається з однією з варіацій методу {@link Seemple#bindNode}, дозволяючи привласнити байндінгі змінної для швидкого видалення.
