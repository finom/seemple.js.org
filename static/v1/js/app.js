...
try {
	...
	var report = 'https://github.com/finom/seemple.io/issues/new?title=Houston,%20we%20have%20a%20problem&body=userAgent: ' + encodeURIComponent(' ' + navigator.userAgent + '\nError: ' + e.message);
...
var Article = function (_MK$Object) {
	...
	_createClass(Article, [{
			...
			return this.on({
				...
				'change:isActive': function changeIsActive(evt) {
					...
					while (node = node.parentNode) {
						(0, _seemple.balalaika)('.submenu-wrapper').filter(function (wrapper) {
				...
				'click::(.share-facebook)': function clickShareFacebook(evt) {
					var url = 'http://www.facebook.com/dialog/feed?app_id=901572946532005&link=' + encodeURIComponent(location.href) + '&name=' + _this2.name + '&description=' + _this2.summary + '&redirect_uri=' + encodeURIComponent('https://seemple.js.org/popupclose.html') + '&display=popup&picture=' + encodeURIComponent('https://seemple.js.org/img/mk_logo.png');

					window.open(url, 'Facebook', 'height=600,width=700');
				}, //
				'click::(.share-twitter)': function clickShareTwitter(evt) {
					var url = 'https://twitter.com/intent/tweet?text=' + encodeURIComponent('#seemplejs ' + _this2.name + ': ' + _this2.summary.substr(0, 60) + '...') + '&url=' + encodeURIComponent(location.href);
		...
		value: function onRender() {
			...
			this.bindNode('id', ':sandbox', _seemple.Seemple.binders.property('id'));
			...
			return this.bindNode({
				...
				since: [':sandbox', _seemple.Seemple.binders.dataset('since')],
				isActive: [':bound(menuItem)', _seemple.Seemple.binders.className('active')],
				expanded: [':bound(menuItem)', _seemple.Seemple.binders.className('expanded')],
				newVersions: [':sandbox', {
				...
				commentsShown: [':bound(commentsContainer)', _seemple.Seemple.binders.visibility()],
				ieVersion: [':sandbox .comments', _seemple.Seemple.binders.className('hide')],
				header: [':sandbox h2', {
			...
			}).bindNode('pagination', [this.sandbox.insertBefore((0, _seemple.balalaika)(paginationHTML)[0], this.sandbox.firstChild), this.sandbox.appendChild((0, _seemple.balalaika)(paginationHTML)[0])]).bindNode('name', ':bound(menuItem)', {
				getValue: function getValue() {
			...
			}, _seemple.Seemple.binders.innerHTML());
		}
	}]);

	return Article;
}(_seemple.Seemple.Object);

exports.default = Article;

},{"../seemple":16,"./globals":5}],3:[function(require,module,exports){
'use strict';
...
var Articles = function (_MK$Array) {
	...
	function Articles() {
		...
		_this.bindNode('header', 'header .inner', _seemple.Seemple.binders.innerHTML()).bindNode('win', window).linkProps('hashValue', [_globals2.default.app, 'hashValue']).linkProps('header', 'active', function (active) {
	...
	return Articles;
}(_seemple.Seemple.Array);

exports.default = Articles;

},{"../seemple":16,"./article.class":2,"./globals":5}],4:[function(require,module,exports){
'use strict';
    ...
    function Examples() {
        ...
        (_this = _possibleConstructorReturn(this, Object.getPrototypeOf(Examples).call(this)), _this).bindNode('sandbox', 'article[id="!examples"]').on('click::(a)', function (evt) {
            ...
            if (!target.classList.contains('initialized')) {
                target.parentNode.appendChild(_seemple.balalaika.create('iframe', {
                    src: target.href,
                    attributes: {
                        width: "100%",
                        height: "500",
...
},{"../seemple":16,"./globals":5}],5:[function(require,module,exports){
"use strict";
...
var Main = function (_MK$Object) {
	...
	function Main() {
		...
		if (/#\w.*/.test(location.hash) && (0, _seemple.balalaika)('[id="!' + location.hash.replace('#', '') + '"]').length) {
		...
		try {
			for (var _iterator = (0, _seemple.balalaika)('a')[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
				var a = _step.value;
		...
		if (_this.ieVersion <= 10) {
			...
			try {
				for (var _iterator2 = (0, _seemple.balalaika)('pre code')[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	...
	_createClass(Main, [{
		...
		value: function bindings() {
			return this.bindNode('demoProp', '.demo .in, .demo .out').bindNode({
				...
				navShown: ['body', _seemple.Seemple.binders.className('nav-shown')],
				isMobile: [':sandbox', _seemple.Seemple.binders.className('mobile')],
				loading: ['.loader', _seemple.Seemple.binders.className('!hide')],
				navOverlay: ['.nav-overlay', _seemple.Seemple.binders.className('!hide')],
				hideTypoBadge: [':bound(typeBadge)', _seemple.Seemple.binders.className('hide')],
				htmlTitle: ['head title', _seemple.Seemple.binders.innerHTML()],
				isOldIE: [':bound(viewSwitcher)', _seemple.Seemple.binders.visibility(false)],
				...
				view: ['body', _seemple.Seemple.binders.dataset('view')],
				...
				importanceLevel: [':sandbox', _seemple.Seemple.binders.dataset('importanceLevel')],
				hashValue: [window, {
					on: 'hashchange',
					getValue: function getValue() {
				...
				setValue: function setValue(v) {
					_seemple.Seemple.$b(this.children).forEach(function (item) {
						item.classList.toggle('checked', item.getAttribute('data-value') === v);
					});
				},
				initialize: function initialize() {
					this.addEventListener('mousedown', function (evt) {
						if (evt.target !== this) _seemple.Seemple.$b(this.children).forEach(function (item) {
		...
		value: function muut() {
			...
			if (typeof jQuery === 'undefined' || !jQuery.fn.muut) {
				document.body.appendChild(_seemple.balalaika.create('script', {
...
},{"../lib/details-polyfill":13,"../lib/header-hider":14,"../lib/prettify":15,"../seemple":16,"./articles.class":3,"./examples.class":4,"./globals":5,"./notifier.class":7,"./performance.class":8,"./search.class":9,"./typedefs.class":11,"./typo.class":12}],7:[function(require,module,exports){
'use strict';
...
},{"../seemple":16,"./globals":5}],8:[function(require,module,exports){
'use strict';
	...
	function Performance() {
		...
		_this.bindNode('sandbox', '.perf-graph-wrapper').bindNode({
			...
			count: [':sandbox .benchmark-url', {
				setValue: function setValue(v) {
					this.href = {
						10: 'http://jsperf.com/angular-vs-knockout-vs-react-vs-seemple/20',
						50: 'http://jsperf.com/angular-vs-knockout-vs-react-vs-seemple/21',
						100: 'http://jsperf.com/angular-vs-knockout-vs-react-vs-seemple/22',
						500: 'http://jsperf.com/angular-vs-knockout-vs-react-vs-seemple/23',
						1000: 'http://jsperf.com/angular-vs-knockout-vs-react-vs-seemple/24'
					}[v];
				}
			}]
		}).bindNode({
		...
		}, _seemple.Seemple.binders.innerHTML()).on({
		...
		var handler = function handler() {
			...
			for (var _framework2 in valuesMap) {
				var _v2 = valuesMap[_framework2],
				    column = (0, _seemple.balalaika)('.column.' + _framework2)[0];

				column.style.height = _v2 / max * 100 + '%';
				(0, _seemple.balalaika)('div', column)[0].innerHTML = _framework2 === 'mk' ? '' : (100 - _v2 / max * 100 | 0) + '% slower';
			}
		};
...
},{"../seemple":16,"./globals":5}],9:[function(require,module,exports){
'use strict';
...
var _class = function (_MK$Array) {
	...
	function _class(data) {
		...
		(_temp = (_this = _possibleConstructorReturn(this, Object.getPrototypeOf(_class).call(this)), _this), _this.Model = _seemple.Seemple.Object, _this.itemRenderer = '<li>', _temp).set(data).bindNode({
			sandbox: 'header',
			container: ':sandbox .search-results-dropdown',
			search: ':sandbox .search',
			searchMode: [':sandbox', _seemple.Seemple.binders.className('search-mode')]
		}).on({
			...
			'*@render': function render(evt) {
				evt.self.bindNode('header', ':sandbox', _seemple.Seemple.binders.innerHTML()).bindNode('isActive', ':sandbox', _seemple.Seemple.binders.className('active'));
			},
...
},{"../seemple":16,"./globals":5}],10:[function(require,module,exports){
'use strict';
...
var _class = function (_MK$Object) {
	...
	_createClass(_class, [{
		key: 'onRender',
		value: function onRender() {
			this.bindNode('typedef', ':sandbox', _seemple.Seemple.binders.dataset('typedef')).bindNode('isShown', ':sandbox', _seemple.Seemple.binders.className('shown'));
		}
	}]);
...
},{"../seemple":16,"./globals":5}],11:[function(require,module,exports){
'use strict';
...
var _class = function (_MK$Array) {
	...
	function _class() {
		...
		(_temp = (_this = _possibleConstructorReturn(this, Object.getPrototypeOf(_class).call(this)), _this), _this.Model = _typedef2.default, _temp).restore('article[data-typedef]').bindNode('sandbox', 'body').bindNode('overlay', '.typedef-overlay', _seemple.Seemple.binders.className('!hide')).bindNode('overlayOpaque', ':bound(overlay)', {
			setValue: function setValue(v) {
...
},{"../seemple":16,"./globals":5,"./typedef.class":10}],12:[function(require,module,exports){
'use strict';
...
var _class = function (_MK$Object) {
	...
	function _class() {
		...
		(_this = _possibleConstructorReturn(this, Object.getPrototypeOf(_class).call(this)), _this).set({
			...
			pageName: 'entry.339184258'
		}).bindNode('sandbox', 'form.typo').bindNode('shown', ':sandbox', _seemple.Seemple.binders.className('shown')).bindNode({
		...
		}).bindNode('overlay', '.typo-overlay', _seemple.Seemple.binders.className('!hide')).bindNode('overlayOpaque', ':bound(overlay)', {
			setValue: function setValue(v) {
				this.style.opacity = v ? .5 : 0;
			}
		}).bindNode('formURL', ':sandbox', {
		...
		}).bindNode('selection', ':sandbox p.selection', _seemple.Seemple.binders.innerHTML()).on('submit::sandbox', function (evt) {
			this.shown = false;
...
},{"../seemple":16,"./globals":5}],13:[function(require,module,exports){
'use strict';
...
/* istanbul ignore next */body=document.body; /* istanbul ignore next */if(previous){body.appendChild(previous);previous.insertAdjacentHTML('afterend',html);body.removeChild(previous);}else {body.appendChild(node);node.insertAdjacentHTML('afterbegin',html);body.removeChild(node);}}}}(seemple_dir_core_var_core,seemple_dir_core_var_map,seemple_dir_core_initmk,seemple_dir_core_util_common);seemple_dir_core_bindings_getnodes=function(core,map,initMK,util){var selectAll,boundAll,bound; /**
  * @private
...
if(triggerOnInit===true){callback.call(context||object,{triggeredOnInit:true});}return object;};}(seemple_dir_core_var_core,seemple_dir_core_initmk,seemple_dir_core_util_common);seemple_dir_core_events_off=function(core,initMK,util,map){var off=core.off=function(object,names,callback,context){ /* istanbul ignore if  */if(!object||(typeof object==='undefined'?'undefined':_typeof(object))!='object')return object;var objectData=map.get(object),i,path,lastIndexOfET,name;if(!objectData)return object; // if event-callback object is passed to the function
...
lastIndexOfET=name.lastIndexOf('@');if(~lastIndexOfET){path=name.slice(0,lastIndexOfET);name=name.slice(lastIndexOfET+1).replace(/@/g,'.');core._undelegateListener(object,path,name,callback,context);}else {core._removeListener(object,name,callback,context);}}return object;};}(seemple_dir_core_var_core,seemple_dir_core_initmk,seemple_dir_core_util_common,seemple_dir_core_var_map);seemple_dir_core_var_specialevtreg=/_rundependencies:|_runbindings:|change:/;seemple_dir_core_events_addlistener=function(core,initMK,map,specialEvtReg,domEvtReg){var _addListener;core._fastAddListener=function(object,name,callback,context,evtData){var allEvents=map.get(object).events,events=allEvents[name]||(allEvents[name]=[]);events.push({callback:callback,context:context,ctx:context||object,name:name,node:evtData&&evtData.node});if(specialEvtReg.test(name)){ // define needed accessors for KEY
...
if(typeof __root!='undefined'){ /* global seemple, balalaika, seemple_magic, xclass, __root */if(typeof define=='function'&&define.amd){if(__root[d]){__root[d]('seemple',function(){return seemple;});__root[d]('bquery',function(){return seemple.$b;});__root[d]('balalaika',function(){return seemple.$b;});__root[d]('xclass',function(){return seemple.Class;});__root[d]('seemple-magic',function(){return seemple_magic;});}define(function(){return seemple;});}else if((typeof exports==='undefined'?'undefined':_typeof(exports))=="object"){module.exports=seemple;}else {__root.Seemple=__root.MK=seemple;__root.$b=seemple.$b;__root.Class=seemple.Class;}}})();})(typeof window!="undefined"?window:Function("return this")());
