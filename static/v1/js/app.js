...
try {
	...
	var report = 'https://github.com/seemplejs/seemple.io/issues/new?title=Houston,%20we%20have%20a%20problem&body=userAgent: ' + encodeURIComponent(' ' + navigator.userAgent + '\nError: ' + e.message);
		...
		value: function events() {
			...
			return this.on({
				...
				'click::(.share-facebook)': function clickShareFacebook(evt) {
					var url = 'http://www.facebook.com/dialog/feed?app_id=901572946532005&link=' + encodeURIComponent(location.href) + '&name=' + _this2.name + '&description=' + _this2.summary + '&redirect_uri=' + encodeURIComponent('http://seemple.io/popupclose.html') + '&display=popup&picture=' + encodeURIComponent('http://seemple.io/img/mk_logo.png');
